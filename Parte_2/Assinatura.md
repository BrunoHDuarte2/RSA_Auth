...
3. **PRa*Ra* (Chave Privada para Criptografar o Hash)**:
    ...
    - **Matematicamente**, a criptografia com a chave privada no RSA é feita usando a fórmula:assinatura=*H*(*M*)*d*mod*n*
        
        assinatura=H(M)dmod  n
        
        Onde:
        
        - H(M)*H*(*M*): Hash da mensagem.
        - d*d*: Expoente da chave privada.
        - n*n*: Módulo RSA (produto de dois números primos grandes).
...
5. **PU_a (Chave Pública para Verificar a Assinatura)**:
    ...
    - **Matematicamente**, a descriptografia com a chave pública no RSA é feita usando a fórmula:hash_recuperado=assinatura*e*mod*n*
        
        hash_recuperado=assinaturaemod  n
        
        Onde:
        
        - assinaturaassinatura: Assinatura digital.
        - e*e*: Expoente da chave pública.
        - n*n*: Módulo RSA (o mesmo usado na criptografia).
6. **D (Verificação da Assinatura)**:
    ...
    - **Matematicamente**, a verificação é bem-sucedida se:*H*(*M*)=hash_recuperado
...
Para implementar, foi precisa das seguintes **bibliotecas**:
